"""
Django settings for apollobit_41235 project.
...
ROOT_URLCONF = 'apollobit_41235.urls'
...
WSGI_APPLICATION = 'apollobit_41235.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "apollobit_41235 API",
    "DESCRIPTION": "API documentation for apollobit_41235 App",
    "VERSION": "v1",
}
